...
import { createSrcSet, getOptimizedImageUrl } from '../utils';
          ...
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex justify-center space-x-2 download-ignore">
            {images.map((img, slideIndex) => (
              img && <button
                ...
                className={`cursor-pointer h-2 rounded-full transition-all ${currentIndex === slideIndex ? 'bg-white w-4' : 'bg-white/50 w-2'
                  }`}
