...
export const defaultSubjectsByAudience: Record<string, { value: string, label: string }[]> = {
    'Secondary school students (Grade 6–11 / O/L candidates)': secondarySchoolSubjects,
    'Advanced Level students (A/L candidates – Arts, Commerce, Science, Technology)': advancedLevelSubjects,
};
