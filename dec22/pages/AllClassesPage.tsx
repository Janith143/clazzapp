...
const AllClassesPage: React.FC = () => {
  ...
  const { pageState, handleNavigate, allSubjects, subjects } = useNavigation();
  const options = pageState.name === 'all_classes' ? pageState.options : {};

  useSEO(
    'All Classes | clazz.lk',
    'Find live online and physical classes that fit your schedule.'
  );
  ...
  const [showLiveOnly, setShowLiveOnly] = useState(options?.ongoingOnly || false);
  ...
  useEffect(() => {
    const handleScroll = () => {
        ...
        // A threshold of 200px helps prevent the bar from hiding on small scrolls near the top.
                    ...
                    <div className="flex flex-col justify-end md:col-span-4">
                        <div className="flex items-center space-x-2">
                             <button
                                ...
                                className={`${
                                    showLiveOnly ? 'bg-red-600' : 'bg-gray-200 dark:bg-gray-600'
                            ...
                            >
                                <span
                                    aria-hidden="true"
                                    className={`${
                                        showLiveOnly ? 'translate-x-5' : 'translate-x-0'
