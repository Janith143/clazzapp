...
const BottomNavBar: React.FC = () => {
    ...
    return (
        <nav className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-light-surface/80 dark:bg-dark-surface/80 backdrop-blur-md border-t border-light-border dark:border-dark-border shadow-[0_-2px_10px_rgba(0,0,0,0.05)] z-40">
